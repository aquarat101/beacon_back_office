...
async function fetchSchool() {
    try {
        const res = await fetch(`${config.apiDomain}/schools/get/${props.schoolId}`, {
            method: "GET",
            headers: {
        ...
        if (res.ok) {
            ...
            schoolName.value = school.value.schoolName
        } else {
        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-md relative">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input v-model="schoolName" type="text" disabled
                        class="w-full border rounded-md px-3 py-2 focus:ring-2 bg-gray-200 text-gray-500 focus:ring-blue-400 focus:outline-none" />
                    </input>
                </div>
            </div>
