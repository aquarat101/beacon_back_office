...
const filteredSchools = computed(() => {
  return schools.value.filter((school) => {
    ...
    const matchesLevel =
      !activeFilterLevel.value ||
      school.educationLevel === activeFilterLevel.value;
  ...
  <div class="p-6 relative">
    ...
    <div class="bg-white p-4 rounded-xl shadow mb-4">
      <div class="flex flex-wrap gap-3 items-center">
        ...
        <select
          v-model="filterTypeInput"
          class="border rounded-lg px-3 py-2 pr-16"
        >
      ...
      <div class="flex gap-3 mt-4">
        <button
          @click="isCreateSchoolModalOpen = true"
          class="bg-color-main2 hover:bg-blue-600 text-white px-4 py-2 rounded-lg"
        >
          + Create School
        </button>
