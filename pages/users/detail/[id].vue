    ...
    <div class="p-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow">
            ...
            <div class="flex flex-col gap-6">
                <img src="/images/layout/logo.png" alt="user" class="w-24 h-24 rounded-full" />

                <div class="flex-1">
                    <p class="mt-2"><strong>Email</strong> <br> {{ user.email }}</p>
                    <p class="mt-2"><strong>Phone Number</strong> <br> {{ user.phoneNumber }}</p>
                    <p class="mt-2"><strong>Role</strong> <br> {{ user.role }}</p>
                    <p class="mt-2"><strong>School</strong> <br> {{ user.school }}</p>
